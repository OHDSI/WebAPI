...
public class ConceptSetCrossReference {
  ...
  private String conceptSetId = null;

  @JsonProperty("targetName")
  private String targetName = null;

  @JsonProperty("targetIndex")
  private String targetIndex = "0";

  @JsonProperty("propertyName")
  private String propertyName = null;

  public ConceptSetCrossReference conceptSetId(String conceptSetId) {
  ...
  public ConceptSetCrossReference targetIndex(String targetIndex) {
