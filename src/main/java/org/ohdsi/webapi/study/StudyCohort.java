...
public class StudyCohort {
	...
	@CollectionTable(name = "STUDY_COHORT_CONCEPT", joinColumns = {
		@JoinColumn(name = "STUDY_COHORT_ID", referencedColumnName = "ID")})
	private List<Concept> concepts;

	@ElementCollection
	@CollectionTable(name = "STUDY_COHORT_REL", joinColumns = {
		@JoinColumn(name = "COHORT_1_ID", referencedColumnName = "ID")})
