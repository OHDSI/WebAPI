...
from @ohdsi_database_schema.heracles_results_dist hrd1
	...
	CAST(CASE WHEN isNumeric(hrd1.stratum_1) = 1 THEN hrd1.stratum_1 ELSE null END AS INT) = c1.concept_id
	inner join @cdm_database_schema.concept c2 on
	CAST(CASE WHEN isNumeric(hrd1.stratum_2) = 1 THEN hrd1.stratum_2 ELSE null END AS INT) = c2.concept_id
