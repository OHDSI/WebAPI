...
//    private HideSensitiveInfoMigration hideSensitiveInfoMigration;
    ...
    public static class MigrationDAO extends AbstractDaoService{
        ...
        public Map<Integer, Source> getSourceData(String webAPISchema) {
            String[] params = new String[]{"webapi_schema", "webapi_schema", "webapi_schema", "webapi_schema", "webapi_schema", "webapi_schema"};
            String[] values = new String[]{webAPISchema, webAPISchema, webAPISchema, webAPISchema, webAPISchema, webAPISchema};
