...
public abstract class AtlasSecurity extends Security {
  ...
  public AtlasSecurity() {
    ...
    this.sourcePermissionTemplates.put("cohort-characterization:*:generate:%s:post", "Generate Cohort Characterization on Source with SourceKey = %s");
  ...
  protected FilterChainBuilder setupProtectedPaths(FilterChainBuilder filterChainBuilder) {
    ...
    return filterChainBuilder
      ...
      .addProtectedRestPath("/cohort-characterization/*/generations")
      .addProtectedRestPath("/cohort-characterization/generations/*/results")
