...
public class CohortDefinitionDetailsEntity implements Serializable {
  ...
  public CohortDefinitionDetailsEntity setExpression(String expression) {
  ...
  public CohortDefinitionDetailsEntity setCohortDefinition(CohortDefinitionEntity definition) {
