...
delete from ${ohdsSchema}.sec_permission where
    value like 'cohort-characterization:%:generation:*:post' or
    value like 'cohort-characterization:%:generation:*:delete';
...
CROSS JOIN (
  SELECT 'cohort-characterization:%:generation:*:post' val UNION ALL
  SELECT 'cohort-characterization:%:generation:*:delete' val
) new_perms
