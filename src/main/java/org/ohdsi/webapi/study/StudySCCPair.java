...
public class StudySCCPair {
	...
	@Id
	@ManyToOne(targetEntity = StudySCC.class)
	...
	@JoinTable(name = "STUDY_SCC_NEG_CONTROL_XREF", joinColumns = {
		@JoinColumn(name = "TARGET_ID", referencedColumnName = "TARGET_ID")
		,@JoinColumn(name = "OUTCOME_ID", referencedColumnName = "OUTCOME_ID")
		,@JoinColumn(name = "SCC_ID", referencedColumnName = "SCC_ID")}, inverseJoinColumns = {
