...
CREATE TABLE ${ohdsiSchema}.BATCH_JOB_EXECUTION  (
	...
	references ${ohdsiSchema}.BATCH_JOB_INSTANCE(JOB_INSTANCE_ID)
) ;
...
CREATE TABLE ${ohdsiSchema}.BATCH_STEP_EXECUTION_CONTEXT  (
	...
	references ${ohdsiSchema}.BATCH_STEP_EXECUTION(STEP_EXECUTION_ID)
) ;
...
CREATE TABLE ${ohdsiSchema}.BATCH_STEP_EXECUTION_SEQ (ID BIGINT IDENTITY);
CREATE TABLE ${ohdsiSchema}.BATCH_JOB_EXECUTION_SEQ (ID BIGINT IDENTITY);
CREATE TABLE ${ohdsiSchema}.BATCH_JOB_SEQ (ID BIGINT IDENTITY);