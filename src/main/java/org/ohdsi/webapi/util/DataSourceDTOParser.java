...
public class DataSourceDTOParser {
    ...
    public static DataSourceDTO parseDTO(Source source) {
        ...
        DataSourceDTO dto = parseConnectionString(source.getSourceConnection());
        dto.setType(dbmsType);

        return dto;
    }

    public static DataSourceDTO parseConnectionString(String connString) {
