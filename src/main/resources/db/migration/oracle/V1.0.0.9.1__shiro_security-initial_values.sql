...
INSERT INTO ${ohdsiSchema}.SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (203, 'role:put', 'Create role');
...
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 200);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 201);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 202);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 203);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 204);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 205);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 206);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 207);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 208);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 209);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 210);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (2, 211);

-- concept set creator
INSERT INTO ${ohdsiSchema}.SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (30, 'conceptset:put', 'Create Concept Set');

INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (3, 30);

-- cohort creator
INSERT INTO ${ohdsiSchema}.SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (50, 'cohortdefinition:put', 'Save new Cohort Definition');
...
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (5, 50);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (5, 51);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (5, 52);
...
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 60);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 61);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 62);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 63);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 64);
INSERT INTO ${ohdsiSchema}.SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (6, 65);
