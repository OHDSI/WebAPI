...
@Path("/ir/")
public interface IRAnalysisService {
    ...
    List<IRAnalysisServiceImpl.IRAnalysisListItem> getIRAnalysisList();
    ...
    @Transactional
    IRAnalysisServiceImpl.IRAnalysisDTO createAnalysis(IRAnalysisServiceImpl.IRAnalysisDTO analysis);
    ...
    IRAnalysisServiceImpl.IRAnalysisDTO getAnalysis(@PathParam("id") final int id);

    @PUT
    @Path("/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    @Transactional
    IRAnalysisServiceImpl.IRAnalysisDTO saveAnalysis(@PathParam("id") final int id, IRAnalysisServiceImpl.IRAnalysisDTO analysis);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Transactional(readOnly = true)
    List<IRAnalysisServiceImpl.AnalysisInfoDTO> getAnalysisInfo(@PathParam("id") final int id);
    ...
    IRAnalysisServiceImpl.IRAnalysisDTO copy(@PathParam("id") final int id);
