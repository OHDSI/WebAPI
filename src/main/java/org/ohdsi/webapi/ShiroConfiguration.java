...
import org.ohdsi.webapi.shiro.management.CaseSensitiveProperties;
...
@Configuration
@EnableConfigurationProperties(CaseSensitiveProperties.class)
public class ShiroConfiguration {
  ...
  @Bean
  @DependsOn("flyway")
  public Security security(CaseSensitiveProperties caseSensitiveProperties) {
    if (enabled) {
      log.debug("AtlasSecurity module loaded");
      return new AtlasSecurity(caseSensitiveProperties);
    }
    else {
