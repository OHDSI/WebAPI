...
//    this.cohortdefinitionImporterPermissionTemplates.put("cohortdefinition:%s:export:*:get", "Export Cohort Definition generation results for defintion with ID = %s");
  ...
  public Map<String, String> getFilterChain() {
    ...
    return new FilterChainBuilder()
      ...
      .addOAuthPath("/user/oauth/cas", "casAuthc")
  ...
  public Map<String, Filter> getFilters() {
    ...
    SecurityFilter casOauthFilter = new SecurityFilter();
    casOauthFilter.setConfig(cfg);
    casOauthFilter.setClients("CasClient");
    filters.put("casAuthc", casOauthFilter);
