SELECT s.source_key, os.target_cohort_id, td.cohort_definition_name as target_cohort_name,
	os.outcome_cohort_id, od.cohort_definition_name as outcome_cohort_name,
