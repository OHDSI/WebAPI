...
public class Report {
	...
	@CollectionTable(name = "REPORT_CONTENT", joinColumns = {
	...
	@CollectionTable(name = "REPORT_SOURCE_XREF", joinColumns = {
		@JoinColumn(name = "REPORT_ID", referencedColumnName = "ID")})
	private List<ReportSource> sources = new java.util.ArrayList<ReportSource>();

	@ElementCollection(fetch = FetchType.LAZY)
	@OrderColumn(name = "ORDINAL")
	@CollectionTable(name = "REPORT_COHORTPAIR_XREF", joinColumns = {
		@JoinColumn(name = "REPORT_ID", referencedColumnName = "ID")})
	...
	@JoinTable(name = "REPORT_STUDY_XREF", joinColumns = {
