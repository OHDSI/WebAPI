...
IF OBJECT_ID(N'DRUG_HOI_EVIDENCE', N'U') IS NOT NULL DROP TABLE DRUG_HOI_EVIDENCE; 
IF OBJECT_ID('DRUG_HOI_EVIDENCE_SEQUENCE', 'SO') IS NOT NULL DROP SEQUENCE DRUG_HOI_EVIDENCE_SEQUENCE;
CREATE SEQUENCE DRUG_HOI_EVIDENCE_SEQUENCE MAXVALUE 9223372036854775807 NO CYCLE;
CREATE TABLE DRUG_HOI_EVIDENCE (
    ID                          INTEGER NOT NULL DEFAULT NEXT VALUE FOR DRUG_HOI_EVIDENCE_SEQUENCE,
...
IF OBJECT_ID(N'EVIDENCE_SOURCES', N'U') IS NOT NULL DROP TABLE EVIDENCE_SOURCES;
IF OBJECT_ID('EVIDENCE_SOURCES_SEQUENCE', 'SO') IS NOT NULL DROP SEQUENCE EVIDENCE_SOURCES_SEQUENCE;
CREATE SEQUENCE EVIDENCE_SOURCES_SEQUENCE MAXVALUE 9223372036854775807 NO CYCLE;
CREATE TABLE EVIDENCE_SOURCES (
    ID                          INTEGER NOT NULL DEFAULT NEXT VALUE FOR EVIDENCE_SOURCES_SEQUENCE,
    TITLE                       VARCHAR(4000),
...
IF OBJECT_ID(N'DRUG_HOI_RELATIONSHIP', N'U') IS NOT NULL DROP TABLE DRUG_HOI_RELATIONSHIP;
...
IF OBJECT_ID(N'LAERTES_SUMMARY', N'U') IS NOT NULL DROP TABLE LAERTES_SUMMARY;
IF OBJECT_ID('LAERTES_SUMMARY_SEQUENCE', 'SO') IS NOT NULL DROP SEQUENCE LAERTES_SUMMARY_SEQUENCE;
CREATE SEQUENCE LAERTES_SUMMARY_SEQUENCE MAXVALUE 9223372036854775807 NO CYCLE;
CREATE TABLE LAERTES_SUMMARY (
	ID                      INTEGER NOT NULL DEFAULT NEXT VALUE FOR LAERTES_SUMMARY_SEQUENCE,
