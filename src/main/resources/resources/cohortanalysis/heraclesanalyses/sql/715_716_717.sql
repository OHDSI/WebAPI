-- @analysisId   Distribution of days_supply by drug_concept_id
...
select c1.cohort_definition_id, c1.subject_id, de1.drug_concept_id, de1.@fieldName as count_value
...
WITH cteRawData as
(
    select cohort_definition_id, drug_concept_id AS stratum_1, count_value FROM #raw_@analysisId
),
    overallStats as
  (
