...
WHERE vo1.visit_start_date >= c1.cohort_start_date and vo1.visit_end_date <= c1.cohort_end_date} :
{join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on vo1.person_id = c1.subject_id}
...
: {		inner join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on vo0.person_id = c1.subject_id}
 		group by c1.cohort_definition_id, c1.subject_id,
...
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on co1.person_id = c1.subject_id
WHERE 1=1
...
join (
  ...
  from @CDM_schema.condition_occurrence co0
	{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on co0.person_id = c1.subject_id
	where 1=1
...
join (
	...
	{@cohort_period_only == 'true'}?{join #HERACLES_cohort c1} : {join (select subject_id, cohort_definition_id from #HERACLES_cohort) c1}
...
(
	...
	from @CDM_schema.condition_occurrence co1
	join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on co1.person_id = c1.subject_id
	group by c1.cohort_definition_id, c1.subject_id
) t0
...
INTO #raw_512
from @CDM_schema.death d1
{@cohort_period_only == 'true'}?{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 }
	on d1.person_id = c1.subject_id
join
(
  select c1.cohort_definition_id, c1.subject_id, max(drug_exposure_start_date) as max_date
  from @CDM_schema.drug_exposure de1
  join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on de1.person_id = c1.subject_id
  group by c1.cohort_definition_id, c1.subject_id
...
(
  ...
  join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on po1.person_id = c1.subject_id
  group by c1.cohort_definition_id, c1.subject_id
) t0 on d1.person_id = t0.subject_id and c1.cohort_definition_id = t0.cohort_definition_id
{@cohort_period_only == 'true'}?{WHERE d1.death_date>=c1.cohort_start_date and d1.death_date<=c1.cohort_end_date}
;
...
(
  ...
  join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1 on o1.person_id = c1.subject_id
  group by c1.cohort_definition_id, c1.subject_id
) t0 on d1.person_id = t0.subject_id and c1.cohort_definition_id = t0.cohort_definition_id
{@cohort_period_only == 'true'}?{WHERE d1.death_date>=c1.cohort_start_date and d1.death_date<=c1.cohort_end_date}
;
...
from @CDM_schema.procedure_occurrence po1
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on po1.person_id = c1.subject_id
where 1=1
...
join (
  ...
  from @CDM_schema.procedure_occurrence po0
	{@cohort_period_only == 'true'} ?
{	join #HERACLES_cohort c1} : {	join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on po0.person_id = c1.subject_id
	where 1=1
...
FROM @CDM_schema.drug_exposure de1
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on de1.person_id = c1.subject_id
where 1=1
...
join (
  ...
  from @CDM_schema.drug_exposure de0
	{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on de0.person_id = c1.subject_id
	where 1=1
...
from @CDM_schema.observation o1
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on o1.person_id = c1.subject_id
WHERE 1=1
...
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on ce1.person_id = c1.subject_id
WHERE 1=1
...
join (
  ...
  from @CDM_schema.condition_era ce0
	{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on ce0.person_id = c1.subject_id
	where 1=1
...
{@cohort_period_only == 'true'} ?
{join #HERACLES_cohort c1} : {join (select cohort_definition_id, subject_id from #HERACLES_cohort) c1} on m1.person_id = c1.subject_id
where 1=1
