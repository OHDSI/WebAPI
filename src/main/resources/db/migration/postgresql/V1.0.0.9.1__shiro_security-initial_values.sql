...
INSERT INTO SEC_ROLE (ID, NAME) VALUES (3, 'concept set creator');
--INSERT INTO SEC_ROLE (ID, NAME) VALUES (4, 'concept set reader');
INSERT INTO SEC_ROLE (ID, NAME) VALUES (5, 'cohort creator');
...
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (210, 'role:1:permissions:*:put', 'Add permissions to public role');
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (211, 'role:1:permissions:*:delete', 'Remove permissions from public role');
...
-- concept set creator
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (30, 'conceptset:put', 'Create Concept Set');

INSERT INTO SEC_ROLE_PERMISSION (ROLE_ID, PERMISSION_ID) VALUES (3, 30);

-- cohort creator
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (50, 'cohortdefinition:put', 'Save new Cohort Definition');
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (51, 'job:execution:get', 'Get list of jobs');
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (52, 'cohortdefinition:*:copy:get', 'Copy the specified cohort definition');
...
-- cohort reader
INSERT INTO SEC_PERMISSION (ID, VALUE, DESCRIPTION) VALUES (60, 'cohortdefinition:get', 'Get list of Cohort Definitions');
