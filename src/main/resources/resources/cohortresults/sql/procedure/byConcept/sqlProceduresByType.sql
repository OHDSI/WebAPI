...
from @ohdsi_database_schema.heracles_results hr1
	inner join @cdm_database_schema.concept c1 on CAST(hr1.stratum_1 AS INT) = c1.concept_id
	inner join @cdm_database_schema.concept c2 on CAST(hr1.stratum_2 AS INT) = c2.concept_id
