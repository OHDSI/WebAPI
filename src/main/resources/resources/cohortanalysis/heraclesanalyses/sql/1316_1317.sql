...
WITH cteRawData as
(
    select cohort_definition_id, measurement_concept_id as stratum_1, unit_concept_id as stratum_2, count_value FROM #raw_@analysisId
),
    overallStats as
  (
