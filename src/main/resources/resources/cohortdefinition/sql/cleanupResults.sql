...
delete from @results_database_schema.cohort_inclusion where generation_id = (SELECT generation_id FROM @results_database_schema.cohort_generations_ref WHERE cohort_definition_id = @cohort_definition_id);
