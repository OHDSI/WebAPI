SELECT s.source_id,
	...
	os.at_risk_pp, os.cases_pp, os.pt_pp, 
	os.ip_pp * 100.0 as ip_pp, 
	os.ir_pp * 1000.0 as ir_pp,
	os.cases_itt, os.pt_itt, 
	os.ip_itt * 100.0 as ip_itt, 
	os.ir_itt * 1000.0 as ir_itt
