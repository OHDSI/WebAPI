...
from @ohdsi_database_schema.heracles_results hr1
	inner join @cdm_database_schema.concept c1 on hr1.stratum_1 AS INT = CAST(c1.concept_id as VARCHAR(255))
	inner join @cdm_database_schema.concept c2 on hr1.stratum_2 = CAST(c2.concept_id as VARCHAR(255))
