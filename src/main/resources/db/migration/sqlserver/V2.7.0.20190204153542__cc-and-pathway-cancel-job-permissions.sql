...
INSERT INTO ${ohdsiSchema}.sec_permission(id, value, description)
    SELECT NEXT VALUE FOR ${ohdsiSchema}.sec_permission_id_seq, REPLACE(value, ':post', ':cancel:get'), 'Cancel Generation of Cohort Characterization'
...
INSERT INTO ${ohdsiSchema}.sec_permission(id, value, description)
  SELECT NEXT VALUE FOR ${ohdsiSchema}.sec_permission_id_seq, REPLACE(value, ':post', ':cancel:get'), 'Cancel Generation of Pathways'
  FROM ohdsi.SEC_PERMISSION sp
    JOIN ohdsi.SEC_ROLE_PERMISSION srp on srp.PERMISSION_ID = sp.ID
