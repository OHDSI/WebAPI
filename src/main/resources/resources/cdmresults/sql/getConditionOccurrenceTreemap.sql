...
from (select * from @ohdsi_database_schema.achilles_results where analysis_id = 400 ) hr1
	inner join
	(select * from @ohdsi_database_schema.achilles_results where analysis_id = 401 ) hr2
