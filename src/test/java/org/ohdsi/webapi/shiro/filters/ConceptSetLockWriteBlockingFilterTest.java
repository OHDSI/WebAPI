...
public class ConceptSetLockWriteBlockingFilterTest {
    ...
    public void shouldAllowAllIfSnapshotLockingIsDisabled() {
        ConceptSetLockWriteBlockingFilter sut = new ConceptSetLockWriteBlockingFilter(true, null);
    ...
    public void shouldRejectIfLockedConceptSet() {
        ...
        ConceptSetLockWriteBlockingFilter sut = new ConceptSetLockWriteBlockingFilter(false, conceptSetLockingServiceMock);
