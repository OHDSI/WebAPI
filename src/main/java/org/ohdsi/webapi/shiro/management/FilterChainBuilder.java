...
public class FilterChainBuilder {
    ...
    private String customUrlFilter;
    ...
    public FilterChainBuilder setAuthzFilter(FilterTemplates... authzFilters) {
		...
		public FilterChainBuilder setCustomUrlFilter(FilterTemplates... customUrlFilters) {
			this.customUrlFilter = convertArrayToString(customUrlFilters);
			return this;
		}
    ...
    public FilterChainBuilder addProtectedRestPath(String path) {
        return this.addRestPath(path, this.authcFilter + ", " + this.authzFilter + ", " + this.customUrlFilter);
    }
